...
/// https://pastebin.com/eWaUKKZN
/// </summary>
/// <typeparam name="TKey"></typeparam>
/// <typeparam name="TValue"></typeparam>
[Serializable]
public class KeyValuePairListsDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
{
    [SerializeField]
    ...
    public KeyValuePairListsDictionary()
    {
        keys = new List<TKey>();
